               ...
               <li data-aos="zoom-in-up" className="xp-box">
                  ...
                  <ul>
                     <li>
                        ...
                        and GROMACS to compare for compatibility of result under
                        the supervision of Professor Wang Yi and awarded the
                        best poster presentation prize amongst 18 other teams by
                        the professors
                     </li>
                     <br />
                     <li>
                        Utilized server-side simulation processing in
                        LINUX-based OS and enhanced efficiency for the project
                        by cooperating with a partner
                     </li>
                  </ul>
               </li>
            </div>
               ...
               <li data-aos="zoom-in-up" className="xp-box">
                  ...
                  <ul>
                     <li>
                        ...
                        linguist for the department of Hospitality and Personnel
                        under deployment
                     </li>
                     <br />
                     <li>

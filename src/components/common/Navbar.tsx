  ...
  return (
    <div className="fixed right-0 top-0 h-screen">
      ...
      <motion.nav
        ...
        variants={navVariant}
        animate="navbar"
        className={`opacity-0 absolute top-1/2 -translate-y-1/2 right-4 rounded-3xl h-[70svh] flex flex-col justify-around items-end py-40 hover:opacity-100 gap-10 origin-right
